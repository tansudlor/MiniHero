...
namespace minihero.game
{
    public class GameController
    {
        ...
        public void SpawnEnemy() //For Spawn new Enemy and set config stat
        {
            ...
            GameObject enemyClone = GameObject.Instantiate(randomEnemy, InvertStructer.Instance.Int2ToVector2(randomPos), Quaternion.identity);
        ...
        public GameObject SpawnHero() //For Spawn new Hero and set config stat
        {
            ...
            GameObject heroClone = GameObject.Instantiate(randomHero, InvertStructer.Instance.Int2ToVector2(randomPos), Quaternion.identity);
        ...
        public (string character, bool isFinish) StartBattle(HashMapData enemyHashMapData, Character hero, int2 pos) //When Head Hero move to cell that have Enemy
        {
            ...
            {
                RemovePositionCharacter(InvertStructer.Instance.Vector2ToInt2(enemyGameObject.transform.position));
        ...
        public void CollectHero(int2 pos) //When Player Collect Collectable Hero that spawn on Map
        {
            ...
            StoreCharacter(InvertStructer.Instance.Vector2ToInt2(hero.FinishPosition), hero.gameObject, hero);
