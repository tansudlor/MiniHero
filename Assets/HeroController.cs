...
public class HeroController : MonoBehaviour
{
    ...
    {
        yield return new WaitUntil(() => gameController.gridSystem.FirstHero != null);
        heroControl = gameController.gridSystem.FirstHero;
    ...
    void MoveToPosition(Vector3 direction)
    {
        ...
        gameController.RemovePositionCharacter(gameController.Vector2ToInt2(hero.PreviousPosition));
        int2 spatialPos = gameController.Vector2ToInt2(hero.CurrentPosition + direction);
        MoveLine();
    ...
    public void MoveLine()
    {
        ...
        for (int i = 1; i < gameController.HeroList.Count; i++)
        {
            ...
            gameController.RemovePositionCharacter(gameController.Vector2ToInt2(currentHero.PreviousPosition));
            gameController.StoreCharacter(gameController.Vector2ToInt2(currentHero.FinishPosition), currentHero.gameObject, currentHero);
        }
